...
class ItemScreen extends Component {
  ...
  handleChange = (e) => {
    ...
    //   this.state.item.completed = target.value;
    ...
    return (
      <div className="container">
        <form onSubmit={this.handleSubmit} className="white">
          ...
          <div className="input-field">
            <button type="cancel" className="btn pink lighten-1 z-depth-0" onClick={this.handleCancel} value={this.todoList}>Cancel</button>
          </div>
          <div className="input-field">
            <button type="submit" className="btn pink lighten-1 z-depth-0" value={this.todoList}>Submit</button>
          </div>
        </form>
      </div>
    );
